...
class CheckInCoordinator @Inject constructor(
    ...
    private val pendingInstallScanner: PendingInstallScanner = PendingInstallScanner {},
) {
    ...
    private suspend fun cycle() {
        ...
        // Reliable fallback for non-MDM installs (see PendingInstallScanner) — runs before
        // draining events so anything it flags rides in THIS check-in's request, not the next one.
        runCatching { pendingInstallScanner.scan() }
