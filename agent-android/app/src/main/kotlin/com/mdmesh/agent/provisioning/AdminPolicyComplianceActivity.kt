...
import com.mdmesh.agent.BatteryOptimizationExemption
...
class AdminPolicyComplianceActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Requested here, once, before kiosk can ever be active — see BatteryOptimizationExemption.
        BatteryOptimizationExemption.requestIfNeeded(ctx)
