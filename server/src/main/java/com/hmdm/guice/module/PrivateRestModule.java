...
public class PrivateRestModule extends ServletModule {
    ...
    protected void configureServlets() {
        ...
        this.bind(GroupPolicyResource.class);
        ...
        // Eager so its ticker starts at boot, same reasoning as AgentWakeHub above.
        this.bind(com.hmdm.task.GroupPolicyScheduler.class).asEagerSingleton();
    }
}
