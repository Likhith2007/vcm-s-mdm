...
/** Device API origin. Production is same-origin; local Vite can override this for phone testing. */
export function serverBaseUrl(): string {
  return (env.VITE_DEVICE_SERVER_URL || window.location.origin).replace(/\/$/, '');
}
